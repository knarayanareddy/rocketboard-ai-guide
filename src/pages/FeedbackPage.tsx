...
import { CheckCircle2, Flag, ThumbsUp, ThumbsDown, Star, Filter } from "lucide-react";
  ...
  return (
    <DashboardLayout>
      <div className="max-w-5xl mx-auto space-y-8">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Content Feedback</h1>
          <p className="text-sm text-muted-foreground mt-1">Review learner feedback and ratings across all modules.</p>
        </div>
