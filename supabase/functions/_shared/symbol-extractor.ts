...
const STOPLISTS: Record<string, Set<string>> = {
  ...
  common: new Set([
    ...
    "enum", "public", "private", "protected", "static", "readonly", "string", "number", 
    "boolean", "any", "void", "null", "undefined", "true", "false", "item", "data", 
    "id", "name", "uuid", "text", "content"
  ]),
};
 ...
 */
export function normalizeSymbols(rawSymbols: string[], languageHint?: SupportedLanguage): string[] {
 ...
 */
export function extractSymbols(text: string, languageHint?: SupportedLanguage, maxSymbols = 50): string[] {
  if (!text) return [];
